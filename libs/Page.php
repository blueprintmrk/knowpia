...
class Page
{
    ...
    // 分页显示定制
    private $config  = [
        'header' => '<li class="disabled"><a>共%TOTAL_ROW%条/%TOTAL_PAGE%页</a></li>',
        'prev'   => '<',
        'next'   => '>',
        'first'  => '首页',
        'last'   => '末页',
    ...
    public function show()
    {
        ...
        $up_page = $up_row > 0 ? '<li class="previous"><a href="' . $this->url($up_row) . '">' . $this->config['prev'] . '</a></li>' : '<li class="previous disabled"><a>' . $this->config['prev'] . '</a></li>';
        //下一页
