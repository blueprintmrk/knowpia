...
class Tree
{
    ...
    /**
     * [listTree description]
     * @param  [type] $list [description]
     * @return [type]       [description]
     */
    public static function listTree($list, $title = 'title')
    {
        $list = self::list_to_tree($list);
        $tree = '<ul class="tree tree-lines tree-angles" data-ride="tree">';
        ...
        foreach ($list as $key => $value) {
            ...
            $tree .= '<li class="open">';
            $tree .= '<a href="' . url() . '?pid=' . $value['id'] . '">' . $value[$title] . '</a>';
            if (isset($value['_child'])) {
                $tree .= self::_listTree($value['_child'], $title);
            }
            $tree .= '</li>';
        }
        $tree .= '</ul>';
    ...
    public static function _listTree($list, $title)
    {
        $tree = '<ul>';
        foreach ($list as $key => $value) {
            $tree .= '<li class="open">';
